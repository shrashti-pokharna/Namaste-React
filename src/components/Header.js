    ...
    <>
      <header className="fixed top-0 bottom-0 left-0 right-0 z-[1000] h-20 shadow-[0_15px_40px_-20px_rgba(40,44,63,0.15)] w-full bg-white px-5">
        <div className=" h-full min-w-[1200px] max-w-[1200px] flex mx-auto  ">
          ...
          <div className="ml-8 h-10 flex items-center max-w-xs self-center cursor-pointer hover:text-[#fc8019] text-sm group">
            ...
            <li className="mr-[60px] font-semibold hover:text-[#fc8019] group">
              <Link className="flex" to="/checkout">
                <span className="mr-2.5 flex relative">
                  <svg
                    className={`fill-[#60b246]  group-hover:stroke-[#fc8019] stroke-[#60b246]`}
                    viewBox="-1 0 37 32"
                    height="20"
                    width="20"
                    fill="#686b78"
